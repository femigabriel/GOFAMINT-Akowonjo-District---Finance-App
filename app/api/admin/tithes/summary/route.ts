...
type MonthlyBreakdown = Record<string, MonthlySummary>;
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Monthly breakdown
 const monthlyBreakdown = titheRecords.reduce((acc: MonthlyBreakdown, record) => {
  ...
  acc[month].totalTithe += record.records.reduce(
